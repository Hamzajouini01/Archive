...
function Home() {
  ...
  return (
    <div className="row p-4 bg-dark" style={{marginLeft:150, backgroundSize: "100% auto"}} >
      ...
      > <Col style={{xs:"3"}}><h1 style={{}} className="headerEvent">Events</h1>   <img style={{marginLeft:95,marginTop:70  }}  src={S} alt=""/> </Col>
     <Col style={{width:50,xs:"4"}}>   <div  className="eventCnter" style={{width:450,padding:20,borderRadius:30, marginBottom:20, boxShadow: " inset 0px 0px 24px #555"}}>
          ...
          <button className="btnnnnn" onClick={create} type="submit">
            Add Events
          </button>
           </div> </Col> 
      </Row>
